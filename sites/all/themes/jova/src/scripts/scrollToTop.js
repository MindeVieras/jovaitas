...
(function($) {
  ...
  $.scrollToTop = function(el, options) {
    ...
    function setStyle() {
      ...
      $.each(defaultCss, (cssProperty, defaultValue) => {
    ...
    base.init = function() {
      ...
      // Overwrite options
      base.options = $.extend({}, $.scrollToTop.defaultOptions, options)
